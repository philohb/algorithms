...
- [design_patterns](algorithms/design_patterns)
    - [singleton](algorithms/design_patterns/singleton.py)
    - [factory_method](algorithms/design_patterns/factory_method.py)
    - [abstract_factory](algorithms/design_patterns/abstract_factory.py)
    - [builder](algorithms/design_patterns/builder.py)
    - [prototype](algorithms/design_patterns/prototype.py)
    - [adapter](algorithms/design_patterns/adapter.py)
    - [decorator](algorithms/design_patterns/decorator.py)
    - [facade](algorithms/design_patterns/facade.py)
    - [proxy](algorithms/design_patterns/proxy.py)
    - [composite](algorithms/design_patterns/composite.py)
    - [observer](algorithms/design_patterns/observer.py)
    - [strategy](algorithms/design_patterns/strategy.py)
    - [command](algorithms/design_patterns/command.py)
    - [template_method](algorithms/design_patterns/template_method.py)
    - [state](algorithms/design_patterns/state.py)
    - [chain_of_responsibility](algorithms/design_patterns/chain_of_responsibility.py)
